...
<!-- 				<div class = "imageacc1"></div>
 -->
				<div class="content">
					<header id = "BigTitle">
						<h2>K R Y P T O N</h2>
					</header>
					<!-- <p id = "Presentation">Bienvenue sur <strong>Sasa.com</strong>, un site de vetements pas comme les autres.<br /> Découvrez la <a href="#work"> black-box</a>, notre collection <a href="#one">Femme</a> et <a href="#work">Homme</a>. <br />
					<a href="#">Inscrivez-vous </a> et recevez votre black-box chaque jour à 19h. </p> -->
					<div class = "Presentation">
					<a href="boutique/boutique.php">LAST DROPS</a>
					</div>
					<div class = "Presentation">
					<a href="#one">PROMOS</a>
					</div>
...
<!-- 			<section id="two" class="main style2 left dark fullscreen">
				<div class="content box style2">
					<header>
						<h2>Nouveautés Hommes</h2>
					</header>
					<p> ... à voir + changer fond</p>
				</div>
...
<!-- 			<section id="work" class="main style3 primary">
				<div class="content">
					<header>
						<h2><a href= "boutique/index.html">NOS PROMOS</a></h2>
					</header> -->
			...
			<!-- <section id="contact" class="main style3 secondary">
				<div class="content">
					<header>
						...
						<p>Accédez à votre première black-box dès 19h.</p>
					</header>
					<div class="box">
						<form method="post" action="send_post.php">
							...
							<div class="field"><input type="password" name="confirmpassword" placeholder="Confirmer votre Mot de Passe" required/></div>
...
<!-- 			<footer id="footer">
 -->
				...
				<!-- Menu -->
<!-- 					<ul class="menu">
						<li>&copy; 2018 Sasa. Tous droits réservés.</li>
					</ul>
